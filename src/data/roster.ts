...
const microArea: MicroArea = {
  id: 'MA-001',
  name: 'Micro-área Botafogo',
  bounds: { north: -22.945, south: -22.960, east: -43.180, west: -43.200 },
  chaId: 'CHA-001',
};

const families: Family[] = [
  { id: 'FAM-001', name: 'Família Silva', microAreaId: 'MA-001', address: 'Rua Voluntários da Pátria, 110', coordinates: { lat: -22.946, lng: -43.182 }, residents: [] },
  { id: 'FAM-002', name: 'Família Souza', microAreaId: 'MA-001', address: 'Rua São Clemente, 220', coordinates: { lat: -22.946, lng: -43.188 }, residents: [] },
  { id: 'FAM-003', name: 'Família Oliveira', microAreaId: 'MA-001', address: 'Rua General Polidoro, 45', coordinates: { lat: -22.946, lng: -43.193 }, residents: [] },
  { id: 'FAM-004', name: 'Família Santos', microAreaId: 'MA-001', address: 'Rua Dona Mariana, 88', coordinates: { lat: -22.946, lng: -43.198 }, residents: [] },
  { id: 'FAM-005', name: 'Família Ferreira', microAreaId: 'MA-001', address: 'Rua Visconde de Caravelas, 32', coordinates: { lat: -22.948, lng: -43.183 }, residents: [] },
  { id: 'FAM-006', name: 'Família Lima', microAreaId: 'MA-001', address: 'Rua da Passagem, 154', coordinates: { lat: -22.948, lng: -43.189 }, residents: [] },
  { id: 'FAM-007', name: 'Família Costa', microAreaId: 'MA-001', address: 'Rua Real Grandeza, 200', coordinates: null, residents: [] },
  { id: 'FAM-008', name: 'Família Martins', microAreaId: 'MA-001', address: 'Rua Sorocaba, 71', coordinates: { lat: -22.948, lng: -43.194 }, residents: [] },
  { id: 'FAM-009', name: 'Família Pereira', microAreaId: 'MA-001', address: 'Rua Bambina, 18', coordinates: { lat: -22.948, lng: -43.199 }, residents: [] },
  { id: 'FAM-010', name: 'Família Alves', microAreaId: 'MA-001', address: 'Rua Assunção, 305', coordinates: { lat: -22.950, lng: -43.182 }, residents: [] },
  { id: 'FAM-011', name: 'Família Rodrigues', microAreaId: 'MA-001', address: 'Rua Conde de Irajá, 62', coordinates: { lat: -22.950, lng: -43.188 }, residents: [] },
  { id: 'FAM-012', name: 'Família Carvalho', microAreaId: 'MA-001', address: 'Rua Capitão Salomão, 27', coordinates: { lat: -22.950, lng: -43.193 }, residents: [] },
  { id: 'FAM-013', name: 'Família Nascimento', microAreaId: 'MA-001', address: 'Rua das Palmeiras, 140', coordinates: { lat: -22.950, lng: -43.197 }, residents: [] },
  { id: 'FAM-014', name: 'Família Araújo', microAreaId: 'MA-001', address: 'Rua Mena Barreto, 53', coordinates: { lat: -22.952, lng: -43.183 }, residents: [] },
  { id: 'FAM-015', name: 'Família Gomes', microAreaId: 'MA-001', address: 'Rua Marquês de Olinda, 9', coordinates: { lat: -22.952, lng: -43.189 }, residents: [] },
  { id: 'FAM-016', name: 'Família Ribeiro', microAreaId: 'MA-001', address: 'Rua Senador Vergueiro, 167', coordinates: { lat: -22.952, lng: -43.194 }, residents: [] },
  { id: 'FAM-017', name: 'Família Mendes', microAreaId: 'MA-001', address: 'Rua Fernando Mendes, 24', coordinates: { lat: -22.952, lng: -43.198 }, residents: [] },
  { id: 'FAM-018', name: 'Família Dias', microAreaId: 'MA-001', address: 'Praia de Botafogo, 412', coordinates: null, residents: [] },
  { id: 'FAM-019', name: 'Família Fernandes', microAreaId: 'MA-001', address: 'Rua Humaitá, 76', coordinates: { lat: -22.954, lng: -43.182 }, residents: [] },
  { id: 'FAM-020', name: 'Família Barros', microAreaId: 'MA-001', address: 'Rua Pinheiro Guimarães, 138', coordinates: { lat: -22.954, lng: -43.187 }, residents: [] },
  { id: 'FAM-021', name: 'Família Teixeira', microAreaId: 'MA-001', address: 'Rua Martins Ferreira, 41', coordinates: { lat: -22.954, lng: -43.193 }, residents: [] },
  { id: 'FAM-022', name: 'Família Moreira', microAreaId: 'MA-001', address: 'Rua General Severiano, 95', coordinates: { lat: -22.954, lng: -43.197 }, residents: [] },
  { id: 'FAM-023', name: 'Família Nunes', microAreaId: 'MA-001', address: 'Travessa do Mosqueira, 12', coordinates: { lat: -22.956, lng: -43.183 }, residents: [] },
  { id: 'FAM-024', name: 'Família Cardoso', microAreaId: 'MA-001', address: 'Rua Lauro Müller, 250', coordinates: { lat: -22.956, lng: -43.189 }, residents: [] },
  { id: 'FAM-025', name: 'Família Batista', microAreaId: 'MA-001', address: 'Rua Voluntários da Pátria, 358', coordinates: { lat: -22.956, lng: -43.194 }, residents: [] },
  { id: 'FAM-026', name: 'Família Borges', microAreaId: 'MA-001', address: 'Rua São Clemente, 477', coordinates: { lat: -22.956, lng: -43.199 }, residents: [] },
  { id: 'FAM-027', name: 'Família Ramos', microAreaId: 'MA-001', address: 'Rua General Polidoro, 183', coordinates: { lat: -22.958, lng: -43.182 }, residents: [] },
  { id: 'FAM-028', name: 'Família Correia', microAreaId: 'MA-001', address: 'Rua Dona Mariana, 226', coordinates: { lat: -22.958, lng: -43.188 }, residents: [] },
  { id: 'FAM-029', name: 'Família Pinto', microAreaId: 'MA-001', address: 'Rua Visconde de Caravelas, 119', coordinates: { lat: -22.958, lng: -43.193 }, residents: [] },
  { id: 'FAM-030', name: 'Família Azevedo', microAreaId: 'MA-001', address: 'Rua da Passagem, 80', coordinates: { lat: -22.958, lng: -43.197 }, residents: [] },
];
